...
export const plannerPlanListEl = document.getElementById('planner-plan-list');
export const plannerInboxListEl = document.getElementById('planner-inbox-list');
export const plannerPreviewListEl = document.getElementById('planner-preview-list');
